...
const ThreeImageSection = () => {
  return (
    <>
      <div className="font-poppins font-bold text-5xl flex justify-center my-6 text-white">
        About Us
      </div>
      <section id="three-image-section" className="bg-custom-color mx-8 rounded-lg py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-poppins text-5xl font-bold text-center text-gray-800 mb-12">
            Welcome to CSR Club EDC
          </h2>

          {/* Paragraph */}
          <div className="flex justify-center">
            <p className="font-poppins font-bold text-lg text-gray-700 text-center max-w-3xl mb-8">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-20">
            {/* Mission Card */}
            <div className="bg-box-color p-8 rounded-2xl shadow-lg max-w-2xl w-full lg:w-1/3">
              <h3 className="font-poppins text-4xl font-bold text-gray-800 mb-8 underline underline-offset-2">Our Mission</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full lg:w-2/3">
              {/* Card 1 */}
              <div className="group relative h-[28rem] w-full transform transition-transform duration-500 hover:scale-105 rounded-2xl overflow-hidden">
                <img
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center p-4 rounded-lg">
                  <p className="font-poppins text-white text-2xl font-bold mb-4">Sustainability</p>
                  <p className="font-poppins text-white text-lg text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              ...
              <div className="group relative h-[28rem] w-full transform transition-transform duration-500 hover:scale-105 rounded-2xl overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center p-4 rounded-lg">
                  <p className="font-poppins text-white text-2xl font-bold mb-4">Community</p>
                  <p className="font-poppins text-white text-lg text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              ...
              <div className="group relative h-[28rem] w-full transform transition-transform duration-500 hover:scale-105 rounded-2xl overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center p-4 rounded-lg">
                  <p className="font-poppins text-white text-2xl font-bold mb-4">Innovation</p>
                  <p className="font-poppins text-white text-lg text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
